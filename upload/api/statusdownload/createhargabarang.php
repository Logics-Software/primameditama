<?php
  ...
  if (!is_array($data)) {
      //delete data
      $statusdownload->kodebarang = isset($data->kodebarang) ? urldecode($data->kodebarang) : null;
      $statusdownload->kodegudang = isset($data->kodegudang) ? urldecode($data->kodegudang) : null;
      $statusdownload->deletestatusharga();

      //insert data
      $statusdownload->kodebarang = isset($data->kodebarang) ? urldecode($data->kodebarang) : null;
      $statusdownload->kodegudang = isset($data->kodegudang) ? urldecode($data->kodegudang) : null;
      if ($statusdownload->createstatusharga()) {
          $success++;
      } else {
          $fail++;
      }
    ...
    foreach ($data as $item) {
        //delete data
        $statusdownload->kodebarang = isset($item->kodebarang) ? urldecode($item->kodebarang) : null;
        ...
        $statusdownload->kodebarang = isset($item->kodebarang) ? urldecode($item->kodebarang) : null;
        $statusdownload->kodegudang = isset($item->kodegudang) ? urldecode($item->kodegudang) : null;
        if ($statusdownload->createstatusbarang()) {
            $success++;
        } else {
            $fail++;
        }
